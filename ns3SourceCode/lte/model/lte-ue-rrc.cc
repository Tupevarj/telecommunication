...
LteUeRrc::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LteUeRrc")
    ...
    .AddAttribute ("T300",
                   ...
                   MakeTimeChecker ())
	.AddAttribute ("ThresholdRsrpLow",
				   "Threshold value for low RSRP",
				   	DoubleValue(-102.0),
					MakeDoubleAccessor(&LteUeRrc::m_rsrpThrLow),
					MakeDoubleChecker<double>())
	.AddAttribute ("T310",
					"Timer for UE to get back in synchronization with the eNodeB",
    ...
    .AddTraceSource ("HandoverEndError",
                     ...
                     "ns3::LteUeRrc::ImsiCidRntiTracedCallback")
	.AddTraceSource("A2RsrqEnter", "trace fired upon entering A2 event",
					MakeTraceSourceAccessor (&LteUeRrc::m_A2RsrqEnterTrace),
					"ns3::LteUeRrc::EventEnterCallback")
	.AddTraceSource("A2RsrqLeave", "trace fired upon leaving A2 event",
					MakeTraceSourceAccessor (&LteUeRrc::m_A2RsrqLeaveTrace),
					"ns3::LteUeRrc::EventLeaveCallback")
	.AddTraceSource("OutOfSynch",
					"trace fired when RSRP value from serving cell is lower than threshold value for low RSRP",
					MakeTraceSourceAccessor(&LteUeRrc::m_outOfSynchTrace),
					"ns3::LteUeRrc::OutOfSynchCallback")
	.AddTraceSource("RadioLinkFailure",
					"trace fired when Radio Link Failure triggered",
					MakeTraceSourceAccessor(&LteUeRrc::m_radioLinkFailureTrace),
					"ns3::LteUeRrc::RadioLinkFailureCallback")
	.AddTraceSource("A2RsrpEnter", "trace fired upon entering A2 event",
					MakeTraceSourceAccessor(&LteUeRrc::m_A2RsrpEnterTrace),
					"ns3::LteUeRrc::EventEnterCallback")
	.AddTraceSource("A2RsrpLeave", "trace fired upon leaving A2 event",
					MakeTraceSourceAccessor(&LteUeRrc::m_A2RsrpLeaveTrace),
					"ns3::LteUeRrc::EventLeaveCallback")
	.AddTraceSource("A3Rsrp", "trace fired upon entering A3 event",
					MakeTraceSourceAccessor(&LteUeRrc::m_A3RsrpTrace),
					"ns3::LteUeRrc::EventEnterCallback")
	.AddTraceSource("KpiTest", "test trace",
					MakeTraceSourceAccessor(&LteUeRrc::m_KpiTrace),
					"ns3::LteUeRrc::KpiTraceCallback")

   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   //
   //	CHANGE MADE HERE:
   //		- ADDED TWO ATTRIBUTES
   //		- ADDED FOUR TRACE SOURCES
   //
   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//	  ///////////////////////////////////////////////////////////////////////////////////////////////
//
//	  m_KpiTrace(m_imsi, newMeasIt->m_cellId, newMeasIt->m_rsrp, newMeasIt->m_rsrq);
//
//	  ///////////////////////////////////////////////////////////////////////////////////////////////
...
void
LteUeRrc::OutOfSynchTimeout(double rsrp)
{
	m_radioLinkFailureTrace(m_imsi, m_cellId, rsrp);
	m_outOfSynchTimeout.Cancel();
	m_firstOutOfSynch = false;
}
                              ...
                              bool useLayer3Filtering)
{
  ...
  //
  //	CHANGE MADE HERE:
  //		- CHECK OUT-OF-SYNCH AND IN-SYNCH
  //
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if(cellId == m_cellId && rsrp < m_rsrpThrLow)
    {
	  // Out-of-synch detected
	  m_outOfSynchTrace(m_imsi, cellId, rsrp, Simulator::Now().GetSeconds());
	  if(!m_firstOutOfSynch)
	  {
		  m_outOfSynchTimeout = Simulator::Schedule (m_t310, &LteUeRrc::OutOfSynchTimeout, this, rsrp);
		  m_firstOutOfSynch = true;
	  }
    }
  else if(cellId == m_cellId && m_outOfSynchTimeout.IsRunning())
    {
	  // In-synch detected
	  m_outOfSynchTimeout.Cancel();
	  m_firstOutOfSynch = false;
        ...
        if (entryCond)
          {
            if (!isMeasIdInReportList)
              {
            	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            	//	CHANGE MADE HERE: FIRE A2 ENTER TRACE
            	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

            	if(reportConfigEutra.triggerQuantity == LteRrcSap::ReportConfigEutra::RSRQ)
            		m_A2RsrqEnterTrace(m_imsi, m_cellId, m_storedMeasValues[m_cellId].rsrq);

            	else if (reportConfigEutra.triggerQuantity == LteRrcSap::ReportConfigEutra::RSRP)
            		m_A2RsrpEnterTrace(m_imsi, m_cellId, m_storedMeasValues[m_cellId].rsrq);
        ...
        if (leavingCond)
          {
            if (isMeasIdInReportList)
              {
            	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            	//	CHANGE MADE HERE: FIRE A2 Leave TRACE
            	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

            	if(reportConfigEutra.triggerQuantity == LteRrcSap::ReportConfigEutra::RSRQ)
            		m_A2RsrqLeaveTrace(m_imsi, m_cellId, m_storedMeasValues[m_cellId].rsrq);

            	else if (reportConfigEutra.triggerQuantity == LteRrcSap::ReportConfigEutra::RSRP)
            		m_A2RsrpLeaveTrace(m_imsi, m_cellId, m_storedMeasValues[m_cellId].rsrq);
            	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (entryCond)
              {
                ...
                if (!hasTriggered)
                  {
                	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                	//	CHANGE MADE HERE: FIRE A3 ENTER TRACE
                	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//      //	CHANGE MADE
//      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//	  bool reportOnEntryA2 = (reportConfigEutra.eventId == LteRrcSap::ReportConfigEutra::EVENT_A2);
//
//	   if(reportOnEntryA2)
//	   {
//		   m_A2RSRQEnterTrace(m_imsi, m_storedMeasValues[m_cellId].rsrq, m_cellId, 0);
//	   }
//
//	  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//      bool reportOnLeaveA2 = (reportConfigEutra.eventId == LteRrcSap::ReportConfigEutra::EVENT_A2);
//
//      if(reportOnLeaveA2)
//      {
//      	m_A2RSRQLeaveTrace(m_imsi, m_storedMeasValues[m_cellId].rsrq, m_cellId, 0);
//      }
//      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
